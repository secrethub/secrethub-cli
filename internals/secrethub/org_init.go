...
func (cmd *OrgInitCommand) Register(r command.Registerer) {
	...
	clause.Var(&cmd.name, "name", "The name you would like to use for your organization. If not set, you will be asked for it.")
	clause.StringVar(&cmd.description, "description", "", "A description (max 144 chars) for your organization so others will recognize it. If not set, you will be asked for it.")
